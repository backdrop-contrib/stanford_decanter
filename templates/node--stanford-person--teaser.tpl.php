...
/**
 * @file
 * Theme implementation to display a person teaser.
 *
 * Available variables:
...
<article id="node-<?php print $node->nid; ?>" class="<?php print implode(' ', $classes); ?> clearfix"<?php print backdrop_attributes($attributes); ?>>
  ...
  <?php
    if (isset($content['field_s_person_profile_picture'])) {
      print render($content['field_s_person_profile_picture']);
      hide($content['field_s_person_profile_picture']);
    }?>
