...
/**
 * @file
 * Template for the Stanford layout designed to work with Decanter framework
 ...
 *   - $content['bottom']
 *   - $content['footer']
 *   - $content['stanfordfooter']
 *
 */
?>
<div class="layout--stanford <?php print implode(' ', $classes); ?>"<?php print backdrop_attributes($attributes); ?>>
  <div id="skip-link">
    <a href="#main-content" class="element-invisible element-focusable"><?php print t('Skip to main content'); ?></a>
  </div>

  <?php if ($content['identitybar']): ?>
    <header class="l-identitybar" role="banner" aria-label="<?php print t('Identity Bar'); ?>">
      <div class="l-identitybar">
        <?php print $content['identitybar']; ?>
      </div>
    </header>
  <?php endif; ?>
