...
- Install the [Theme Hooks module](https://github.com/ronan/theme_hooks) is REQUIRED to allow the theme work correctly and to expose some global identity blocks that can be added to the site's header and footer.
